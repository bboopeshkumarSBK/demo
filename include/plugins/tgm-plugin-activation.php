...
function new_photography_wp_tgmpa_register() {
	...
	// Register notice
	tgmpa( $plugins, array(
		'id'           => 'new_photography_wp_theme',
		'domain'       => 'new_photography_wp',
...
add_action( 'tgmpa_register', 'new_photography_wp_tgmpa_register' );
}
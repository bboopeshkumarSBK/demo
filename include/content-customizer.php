...
function new_photography__customize_register_content( $wp_customize ) {
/**
 * Recent Posts
 */
		$wp_customize->add_section( 'seos_content_section' , array(
			'title'       => __( 'Content Options', 'new-photography' ),
			'priority'    => 2,	
		...
		$wp_customize->add_control( 'content_max_width', array(
		  ...
		  'label' => __( 'Content max width', 'new-photography' ),
		  'input_attrs' => array(
			'min' => 1210,
			'max' => 2000,
			'step' => 1,
		 ...
		 $wp_customize->add_control( 'content_padding', array(
		  ...
		  'label' => __( 'Content Padding', 'new-photography' ),
		  'input_attrs' => array(
			'min' => 0,
			'max' => 100,
			'step' => 1,
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'hide_home_content', array(
			'label'    => __( 'Hide sidebar and content on home page', 'new-photography' ),
			'section'  => 'seos_content_section',
			'priority'    => 1,				
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'hide_featured', array(
			'label'    => __( 'Show featured images on all single pages.', 'new-photography' ),
			'section'  => 'seos_content_section',
			'priority'    => 1,				
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'article_font_size', array(
			'label'    => __( 'Article Font Size in px.', 'new-photography' ),
			'section'  => 'seos_content_section',
			'priority'    => 1,				
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'article_justify', array(
			'label'    => __( 'Article Text Align - Justify', 'new-photography' ),
			'section'  => 'seos_content_section',
			'priority'    => 1,				
...
add_action( 'customize_register', 'new_photography__customize_register_content' );
/********************************************
* Content Styles
*********************************************/ 	
function new_photography__content_styles () {
...
add_action( 'wp_enqueue_scripts', 'new_photography__content_styles' );
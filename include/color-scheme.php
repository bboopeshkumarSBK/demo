...
add_action( 'customize_register', 'new_photography_color_scheme_customize' );
function new_photography_color_scheme_customize( $wp_customize ) {

		$wp_customize->add_section( 'seos_color_scheme' , array(
			'title'       => __( 'Color Scheme', 'new-photography' ),
			'priority'    => 2,
		) );
 		...
 		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'color_scheme', array(
			'label'    => __( 'Color Scheme', 'new-photography' ),
			'priority' => 14,
 		...
 		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'color_scheme_hover', array(
			'label'    => __( 'Hover Color', 'new-photography' ),
			'priority' => 14,
			'section'  => 'seos_color_scheme',
...
add_action( 'wp_enqueue_scripts', 'new_photography_color_scheme' );	
function new_photography_color_scheme() {

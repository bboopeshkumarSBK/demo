 ...
 */
?>
<article <?php echo wp_kses_post(new_photography__animation( "new_photography__articles_animation" )); ?> id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		...
		the_content( sprintf(
			wp_kses(
				...
				__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'new-photography' ),
				array(
					'span' => array(
						'class' => array(),
					),
		...
		wp_link_pages( array(
			'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'new-photography' ),
			'after'  => '</div>',
		) );
		?>
	</div><!-- .entry-content -->
	...
	<footer class="entry-footer">
		<?php if ( 'post' === get_post_type() ) :
			...
			<div class="entry-meta">
				<?php
				new_photography__posted_on();
				new_photography__posted_by();
				new_photography__entry_footer();
				?>
			</div><!-- .entry-meta -->
		<?php endif; ?>	
	</footer><!-- .entry-footer -->
